...
<html lang="en">
    <head>
        ...
        <title>BlogArtikel-Edit Artikel</title>
                                        ...
                                        <div class="block block-rounded">
                                            <div class="block-header block-header-default">
                                                ...
                                                <div class="block-options">
                                                    <button type="submit" class="btn btn-sm btn-primary" name="edit_artikel">
                                                        Edit
                                                    </button>
                                                    ...
                                                    <div class="col-sm-10 col-md-11">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="custom-file">
                                                                ...
                                                                <!-- <img src="imgArtikel/<?= $data['artikel_gambar']; ?>" width="80"> -->
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control form-control-alt" id="block-form1-password" name="judul" placeholder="Masukkan judul" value="<?= $data['artikel_judul']; ?>">
                                                        </div>
                                                        <!-- End Judul artikel -->
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="js-ckeditor" name="isi"><?= $data['artikel_isi']; ?></textarea>
                                                        </div>
                                                        <!-- End Judul artikel -->
